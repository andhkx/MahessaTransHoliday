...
<head>
    ...
    <title>Tulis Artikel Baru - Admin Mahessa</title>
...
<div class="container pb-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="h4 fw-bold mb-1">Tulis Artikel Baru</h2>
            <p class="text-muted small mb-0">Publikasikan konten menarik untuk pelanggan Anda.</p>
        </div>
        ...
        <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-4">
                <div class="col-12">
                    ...
                    <input type="text" name="title" class="form-control" value="{{ old('title') }}" placeholder="Contoh: 5 Tips Liburan Hemat ke Bali" required>
                </div>
                ...
                <div class="col-12">
                    ...
                    <textarea name="body" class="form-control" rows="12" placeholder="Ketik isi artikel Anda di sini..." required>{{ old('body') }}</textarea>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <select name="is_active" class="form-select">
                        <option value="1" {{ old('is_active') == '1' ? 'selected' : '' }}>🟢 Publish (Langsung tampil di website)</option>
                        <option value="0" {{ old('is_active') == '0' ? 'selected' : '' }}>⚪ Draft (Simpan dan sembunyikan dulu)</option>
                    </select>
                </div>
