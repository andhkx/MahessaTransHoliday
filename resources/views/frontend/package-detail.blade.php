...
<head>
  ...
  <style>
    ...
    .btn-whatsapp { @apply inline-flex items-center justify-center w-10 h-10 bg-green-500 text-white font-bold text-sm rounded-full transition-all hover:bg-green-600 hover:-translate-y-0.5 hover:shadow-lg; }
